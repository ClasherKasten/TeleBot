...
public class InlineKeyboardButtonTest {
	...
	public void testInlineKeyboardButtonCreation() {
		...
		InlineKeyboardButton callbackButton = new InlineKeyboardButton("Some button", null, "data to be sent", null);
		InlineKeyboardButton urlButton = new InlineKeyboardButton("Another button", "http://www.example.com", null,
				null);
		InlineKeyboardButton switchInlineButton = new InlineKeyboardButton("Chat button", null, null,
				"let me help you");
		...
		assertTrue(switchInlineButton.getSwitchInlineQuery().equals(switchInline.getString("switch_inline_query")));
