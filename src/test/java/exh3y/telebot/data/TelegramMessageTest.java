...
public class TelegramMessageTest {
    ...
    private TelegramMessage createTestMessage(JSONObject json)
        ...
        if (json == null) {
            json =
                    new JSONObject(
                            "{\"message_id\":42,\"from\":{\"id\":547885,\"first_name\":\"Some\",\"last_name\":\"User\",\"username\":\"testuser\"},\"chat\":{\"id\":1337,\"first_name\":\"Some\",\"last_name\":\"User\",\"username\":\"testuser\",\"type\":\"private\"},\"date\":1450006107,\"text\":\"This"
                                + " is a test message.\"}");
        }
