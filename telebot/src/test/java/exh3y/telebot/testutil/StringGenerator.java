...
public class StringGenerator {
	...
	public JSONObject randomJSONMessage(String text) {
		...
		return new JSONObject("{\"message_id\":" + messageId + ",\"from\":{\"id\":" + senderId + ",\"first_name\":\""
				+ firstName + "\",\"last_name\":\"" + lastName + "\",\"username\":\"" + userName
				+ "\"},\"chat\":{\"id\":" + chatId + ",\"first_name\":\"" + firstName + "\",\"last_name\":\"" + lastName
				+ "\",\"username\":\"" + userName + "\",\"type\":\"private\"},\"date\":" + unixTime + ",\"text\":\""
				+ text + "\"}");
